...
import com.fstTanger.core.dao.IPersonneRepository;
import com.fstTanger.core.dao.IRepositoryDao;
import com.fstTanger.core.dao.ICompteRepository;
...
public class CompteServiceImpl implements ICompteService {
	...
	public String createUser(Long idRole, Long idPerson) {Personne person = personDao.findById(idPerson).get();
