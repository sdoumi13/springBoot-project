...
<body>
    <div class="container">
        ...
        <form:form modelAttribute="examen" method="post" action="${pageContext.request.contextPath}/admin/Examen/addExamen" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                <label for="pv">PV (PDF):</label>
                <input type="file" name="pvFile" id="pvFile" class="form-control" accept="application/pdf"/>
            </div>
            <div class="form-group">
                <label for="rapport">Rapport Textuel (PDF):</label>
                <input type="file" name="rapportFile" id="rapportFile" class="form-control" accept="application/pdf"/>
            </div>
            <div class="form-group">
